...
def evaluate_model():
    print("Loading test dataset (Chile 20% Test)...")
    test_df = pd.read_csv("data/raw/chile_test.csv", dtype=str)
    ...
    # Usamos el Índice Maestro con 80% de Chile
    store = VectorStore(
        file_name="data/raw/coicop_master_chile_80.csv",
        data_type="csv",
        vectoriser=vectoriser,
        output_dir="data/coicop_master_chile_80",
        overwrite=True
    )
